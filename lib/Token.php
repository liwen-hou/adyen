...
if (isset($_POST['callFunc1'])) {
  ...
  foreach ($results['paymentMethods'] as $methods) {
    ...
    echo 'method' . $i;
    echo '"><h2 class="mb-0"><img id="cardBrand" src="assets/img/'. $methods['type'] . '@2x.png" height="22" width="33"><button class="btn btn-link" type="button" data-toggle="collapse" data-target="#';
    echo 'collapse' . $i;
